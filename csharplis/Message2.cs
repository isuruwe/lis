...
namespace csharplis
{
    public class Message2
    {
        ...
        {
            if (_segments.Count == 0 || _segments.ElementAt(4).Name != "OBR")
            {
                return null;
            }
            return _segments.ElementAt(4);
        }
        protected Segment nHeader1()
        {
            if (_segments.Count == 0 || _segments.ElementAt(5).Name != "OBX")
            {
                return null;
            }
            return _segments.ElementAt(5);
        }
        protected Segment mHeader(int elat)
        {
            if (_segments.Count == 0 || _segments.ElementAt(elat).Name != "OBX")
            {
                return null;
            }
            return _segments.ElementAt(elat);
        }
        ...
        public String Messagn(int tno, int elat)
        {
            var msh = mHeader(elat);
            if (msh == null) return null;
